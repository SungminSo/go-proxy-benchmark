...
func SetProxyStats(proxy *goproxy.ProxyHttpServer) {
	...
	proxy.OnResponse(goproxy_html.IsWebRelatedText).DoFunc(func(resp *http.Response, ctx *goproxy.ProxyCtx) *http.Response {
